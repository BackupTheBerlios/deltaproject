...
%\begin{center}
%\scalebox{0.7}{\includegraphics{images/FAQConsultant.jpg}}\\
%\par{Package Gestion Faq pour le consultant}
%\end{center}
...
%\begin{center}
%\scalebox{0.7}{\includegraphics{images/FAQEnseignemt.jpg}}\\
%\par{Package Gestion Faq pour l'enseignant}
%\end{center}
