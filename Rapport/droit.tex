...
%\begin{center}
%\scalebox{0.7}{\includegraphics{images/droitResponsable.jpg}}\\
%\par{Paquetage Droit pour le responsable}
%\end{center}
...
%\begin{center}
%\scalebox{0.7}{\includegraphics{images/droitAdmin.jpg}}\\
%\par{Paquetage Droit pour l'administarteur}
%\end{center}
