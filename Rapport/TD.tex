...
\begin{center}
\scalebox{0.7}{\includegraphics{images/TD_Consultant.jpg}}\\
\end{center}
...
\begin{center}
\scalebox{0.7}{\includegraphics{images/TD_Enseignant.jpg}}\\
\end{center}
...
\hline
Associer un TD à un enseignement & 3 & fiable & le projet doit être lié à l'enseignement désiré.\\
\hline
...
\item {\bf Cr{\'e}er un TD :}
	...
	Il s{\'e}lectionne l'enseignement pour lequel le devoir est destin{\'e}, il doit avoir les droits pour insérer son nouveau TD dans l'enseignement désiré\\
...
\begin{center}
\scalebox{0.7}{\includegraphics{images/TD_Administrateur.jpg}}\\
\end{center}
